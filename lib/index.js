...
util.inherits(Jshell, EventEmitter);

Jshell.prototype.pipe = function () {
    var args = Array.prototype.slice.call(arguments);
    if (args[0].writable) {
        this.spawnPipeline(function (err, input, output) {
...
Jshell.prototype.buffer = Promise.promisify(function (callback) {
    var chunks = [];
    this.spawnPipeline(passError(callback, function (input, output) {
